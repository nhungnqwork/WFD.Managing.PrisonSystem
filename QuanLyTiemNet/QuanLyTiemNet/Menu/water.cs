...
namespace QuanLyTiemNet
{
    public partial class water : Form
    {
        ...
        private void label1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    MessageBox.Show("Nạp tiền thành công. Bạn được cộng 6.000d vào tài khoản của mình");
                    sqlConnection.Close();
                    addTranstation1();
                    Menu h = new Menu();
                    h.Show();
        ...
        private void addTranstation1()
        {
            ...
            {
                sqlConnection.Open();
                string query = "insert into TransactionTbl values('" + Tdn + "', '" + TrType + "',  '" + 6 + "', '" + DateTime.Today.Date.ToString() + "')";
