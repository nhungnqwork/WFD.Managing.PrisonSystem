...
{
    public partial class DaGa : Form
    {
        public DaGa()
        {
            InitializeComponent();
        ...
        private void label1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    MessageBox.Show("Nạp tiền thành công. Bạn được cộng 9.000d vào tài khoản của mình");
                    sqlConnection.Close();
                    addTranstation1();
                    Menu h = new Menu();
                    h.Show();
        ...
        private void addTranstation1()
        {
            ...
            {
                sqlConnection.Open();
                string query = "insert into TransactionTbl values('" + Tdn + "', '" + TrType + "',  '" + 9 + "', '" + DateTime.Today.Date.ToString() + "')";
        ...
        private void DaGa_Load(object sender, EventArgs e)
        {
            GetBalance();
        }
    }
